...
class ViewModelMovieList(private val repository: Repository) : ViewModel() {
    private var _movieListLiveData: MutableLiveData<List<MovieDataResponse>> = MutableLiveData()
    val movieListLiveData: LiveData<List<MovieDataResponse>> = _movieListLiveData
